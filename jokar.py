...
def trt6(ids,passlist):
	...
	try:
       ...
       'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="113.0.5642.215", "Google Chrome";v="113.0.5642.215"',
       'sec-ch-ua-mobile': '?1',
      ...
      'user-agent': 'Mozilla/5.0 (Linux; Android 10; iPlay_20) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.5642.215 Mobile Safari/537.36',
      'viewport-width': '980',
}
